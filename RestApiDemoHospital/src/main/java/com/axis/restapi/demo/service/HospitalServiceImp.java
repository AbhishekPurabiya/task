...
import com.axis.restapi.demo.repository.HospitalRepository;
...
public class HospitalServiceImp implements IHospitalService{
	...
	public Hospital getPatientById(int id) {
		...
		try {
			hospital =  repo.findById(id).orElseThrow(()-> new PatientNotFountException("No Such Details Available..."));
		} catch (PatientNotFountException e) {
