					...
					<div clasa="col">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="fname"
								id="foodName" placeholder="Food Name" style="width: 60%;"> <label
					...
					<div clasa="col">
						<div class="form-floating mb-3">
							<input type="number" class="form-control" name="price"
								id="foodprice" placeholder="Food Price" style="width: 60%;"> <label
					...
					<div class="col">
						<div class="form-floating mb-3">
							<input type="number" class="form-control" name="quantity"
								id="foodquantity" placeholder="Food Quantity" style="width: 60%;"> <label
				...
				<div class="row">
					...
					<div class="col">
						<div class="input-group mb-3">
							<input type="file" class="form-control" name="fimage" id="inputGroupFile02" style="width: 60%;">
							<label class="input-group-text" for="inputGroupFile02">Upload Food Image</label>
						</div>
					</div>
				</div>
